...
def recognize_from_microphone():
    ...
    elif speech_recognition_result == speechsdk.ResultReason.NoMatch:
        print("음식 인식불가:{}".format(speech_recognition_result.no_match_details))
...
def recognize_from_microphone():
    ...
    if speech_recognition_result.reason == speechsdk.ResultReason.RecognizedSpeech:
        ...
        print("음성을 텍스트로 변환 취소됨: {}".format(cancellation_details.reason))
        if cancellation_details.reason == speechsdk.CancellationReason.Error:
            print(f"에러: {cancellation_details.error_details}")
